                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="btns-opciones">
                                    ...
                                    @if($cliente->estado == 1)
                                    <a href="#" data-url="{{route('clientes.destroy',$cliente->id)}}" data-toggle="modal" data-target="#modal-eliminar" class="eliminar"><i class="fa fa-minus" data-toggle="tooltip" data-placement="left" title="Eliminar / Dar baja"></i></a>
                                    @else
                                    <a href="{{route('clientes.habilitar',$cliente->id)}}" class="ir-evaluacion"><i class="fa fa-key" data-toggle="tooltip" data-placement="left" title="Habilitar"></i></a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
