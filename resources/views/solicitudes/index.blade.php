                    ...
                    <table class="data-table table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$cont++}}</td>
                                <td>
                                    {{$solicitud->user->empleado->nombre}} {{$solicitud->user->empleado->paterno}} {{$solicitud->user->empleado->materno}}
                                </td>
                                <td>
                                    {{$solicitud->motivo}}
                                </td>
                                ...
                                <td class="btns-opciones">
                                    ...
                                    <a href="#" data-url="{{route('solicitudes.asignar',$solicitud->id)}}" data-toggle="modal" data-target="#modal-asignar" class="asignar ir-evaluacion"><i class="fa fa-key" data-toggle="tooltip" data-placement="left" title="Asignar contraseña"></i></a>
                                    @endif
