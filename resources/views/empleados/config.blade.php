            ...
            <div class="panel panel-default">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        {!! Form::model($user,['route'=>['users.config_update_foto',$user->id],'method'=>'POST','files'=>"true"]) !!}
                            <div class="col-md-4 col-md-offset-4 contenedor_foto">
                                <img src="{{ asset('imgs/users/'.$user->foto) }}" width="150" height="155" id="imagen_select">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="password" id="NewPasswordConfirm" name="password_confirm" class="form-control" required>
                        </div>
                        <div class="col-md-12">
                            <br>
