...
<body>
    <img src="{{asset('imgs/empresa/'.$empresa->logo)}}" alt="Logo" class="logo" style="width:120px;height:60px;">
    ...
    <table class="infoEmpleado">
      <tbody>
        <tr>
            ...
            <td class="td_foto" rowspan="6" colspan="2"><img src="{{asset('imgs/empleado/'.$empleado->foto)}}" alt="Foto" class="foto"></td>
        </tr>
        <tr>
